...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const enterHandler = (e) => {
      ...
      // hide OS cursor only while hovering the target
      if (hideDefaultCursor) {
        document.body.style.cursor = "none";
      }
      // show the custom cursor
      gsap.to(cursorRef.current, { opacity: 1, duration: 0.18 });
      ...
      const leaveHandler = () => {
        ...
        // restore OS cursor when leaving the target
        if (hideDefaultCursor) {
  ...
  return (
    <div
      ref={cursorRef}
      className="fixed top-0 left-0 w-0 h-0 pointer-events-none z-[9999] mix-blend-difference transform -translate-x-1/2 -translate-y-1/2 opacity-0"
