  ...
  return (
    <footer className="relative w-full min-h-[40vh] px-6 md:px-10 py-12 bg-gradient-to-tr from-[#0f0c29] via-[#000000] to-[#24243e] backdrop-blur-xl text-white border-t border-white/10 overflow-hidden z-50 mt-[100px]">
      ...
      <div className="relative z-20 flex flex-wrap justify-center gap-10 items-center text-center md:text-left max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-white">Dinesh Khichar</h2>
          <p className="text-sm md:text-base text-gray-400">Crafting emotions with code.</p>
        </motion.div>
        ...
        >
          <a href="https://github.com/dineshkhichar569" target="_blank" rel="noopener noreferrer" className="hover:text-[#00fff7] transition duration-300">
            <FaGithub />
          </a>
          <a href="https://www.linkedin.com/in/dinesh-khichar-5265b4282/" target="_blank" rel="noopener noreferrer" className="hover:text-[#0072ff] transition duration-300">
            <FaLinkedin />
          </a>
          <a href="https://x.com/IZEL_4582" target="_blank" rel="noopener noreferrer" className="hover:text-[#0072ff] transition duration-300">
            <FaTwitter />
          </a>
          <a href="https://instagram.com/dinesh_458252" target="_blank" rel="noopener noreferrer" className="hover:text-[#0072ff] transition duration-300">
            <FaInstagram />
          </a>
          <a href="mailto:wollverinel97@gmail.com" className="hover:text-[#ff007f] transition duration-300">
            <FaEnvelope />
          </a>
        </motion.div>
      ...
      >
        © {new Date().getFullYear()} Dinesh Khichar · Powered by React & Tailwind · All Rights Reserved.
      </motion.div>
